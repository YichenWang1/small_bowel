...
knitr::opts_knit$set(root.dir = '/Users/yw2/OneDrive\ -\ University\ of\ Cambridge/PhD/small_bowel/data')
```
...
```{r HDP_results1, fig.show="hide", results="hide"}
...
```{r HDP_results2, fig.width = 8, fig.height = 4}
...
```{r deconvolution1, fig.width = 8, fig.height = 4, warning = FALSE}
...
```{r deconvolution2, fig.width = 6, fig.height = 4}
