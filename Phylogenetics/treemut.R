...
load_lib=function(){
  if(system("uname",intern = TRUE)=="Darwin"){
    dyn.load("/lustre/scratch117/casm/team268/tc16/Scripts/TreeAssign/treemut.Darwin.so")
  }else{
    dyn.load("/lustre/scratch117/casm/team268/tc16/Scripts/TreeAssign/treemut.so")
  }
}
load_lib()
